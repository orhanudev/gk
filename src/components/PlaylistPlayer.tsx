...
export function PlaylistPlayer({
  ...
  useEffect(() => {
    if (playlist && playlist.videos.length > 0) {
      ...
      const firstVideoId =
        playlist.videos[playlist.currentVideoIndex || 0]?.id?.videoId ||
        ...
        if (data.event === "video-progress" && data.info) {
          ...
          if (currentTime !== undefined) {
            ...
            if (
              ...
              const videoId =
                currentVideo.id.videoId || String(currentVideo.id) || "";
          ...
          if (playerState === 0) {
            ...
            if (shuffleMode) {
              ...
              if (availableIndices.length > 0) {
                ...
                const newVideoId =
                  newVideo.id.videoId || String(newVideo.id) || "";
  ...
  const embedUrl = `https://www.youtube.com/embed/${currentVideoId}?autoplay=1&modestbranding=1&rel=0&iv_load_policy=3&fs=1&enablejsapi=1&origin=${
    window.location.origin
  }${startTime > 10 ? `&start=${startTime}` : ""}`;
    ...
    >
      ...
      >
        ...
        <div className={`border-b border-gray-700 ${isMobile ? "p-1" : "p-4"}`}>
          <div className="flex items-center justify-center space-x-2 mb-3">
            ...
            <div
              className={`bg-purple-600 text-white rounded-lg flex items-center space-x-2 ${
          ...
          {videoDuration > 0 && (
            <div className="mb-3">
              <div className="flex items-center justify-between text-xs text-gray-400 mb-1">
                <span>
                  {Math.floor(currentVideoPosition / 60)}:
                  {Math.floor(currentVideoPosition % 60)
                    .toString()
                    .padStart(2, "0")}
                </span>
              ...
              <div className="w-full bg-gray-600 rounded-full h-1">
                <div
                  ...
                  style={{
                    width: `${(currentVideoPosition / videoDuration) * 100}%`,
                  }}
                />
              </div>
              {savedPosition > 10 && (
                <div className="text-xs text-green-400 mt-1 text-center">
                  Son izlenen konumdan devam ediliyor (
                  {Math.floor(savedPosition / 60)}:
                  {Math.floor(savedPosition % 60)
                    .toString()
                    .padStart(2, "0")}
                  )
          ...
          <div className="flex items-center justify-center space-x-2">
            <button
              ...
              title={
                autoplay ? "Otomatik oynatmayı kapat" : "Otomatik oynatmayı aç"
              }
            >
            ...
            {playlist.videos.map((video, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`flex-shrink-0 bg-purple-600 rounded-full flex items-center justify-center text-white font-medium ${
                    ...
                    <div className={`${isMobile ? "" : "flex-1"} min-w-0`}>
                      <h5
                        className={`text-white font-medium line-clamp-2 mb-1 ${
                      ...
                      >
                        ...
                        {savedPos > 10 && (
                          <p className="text-green-400 text-xs">
                            Son: {Math.floor(savedPos / 60)}:
                            {Math.floor(savedPos % 60)
                              .toString()
                              .padStart(2, "0")}
                          </p>
                        )}
      ...
      <div
        className={`bg-black flex flex-col ${
          isFullscreen ? "fixed inset-0 z-50" : isMobile ? "flex-1" : "flex-1"
        }`}
      >
        {/* Video Player */}
